 ...
 const handleClear = () => {
   ...
   const handleClick = () => {
    ...
    try{ 
      ...
      setfResult(_TypedDataEncoder.getPrimaryType(typObj));
      setError();
    }catch(e){
      setError('Invalid');
      //console.error(e);
  ...
  return (
     ...
     <Text weight={500} >
       Constructs a directed acyclic graph of the types and returns the root type, which can be used as 
       the primaryType for EIP-712 payloads.
     </Text>
